...
export const api = {
  ...
  getCatalogServiceDetail: (type: string) => request(`/catalog/services/${encodeURIComponent(type)}/detail`),
  getCatalogServiceResources: (type: string) => request(`/catalog/services/${encodeURIComponent(type)}/resources`),
  getCatalogServiceTopology: (type: string) => request(`/catalog/services/${encodeURIComponent(type)}/topology`),
  getCatalogServiceObservability: (type: string) => request(`/catalog/services/${encodeURIComponent(type)}/observability`),
