...
const serviceProfiles: Record<string, Omit<ServiceConfigProfile, 'serviceType'>> = {
  ...
  redis: {
    ...
    fields: [
      ...
      { key: 'sentinel.masterSet', label: 'Sentinel master set', control: 'text', defaultValue: 'mymaster', placeholder: 'mymaster', showWhen: { key: 'architecture', equals: 'sentinel' } },
      { key: 'cluster.nodes', label: 'Cluster 节点数', control: 'number', defaultValue: 6, min: 3, showWhen: { key: 'architecture', equals: 'cluster' } },
      { key: 'cluster.replicas', label: '每主节点副本', control: 'number', defaultValue: 1, min: 0, showWhen: { key: 'architecture', equals: 'cluster' } },
      { key: 'persistence.enabled', label: 'Cluster 存储', control: 'switch', defaultValue: false, showWhen: { key: 'architecture', equals: 'cluster' } },
      { key: 'persistence.size', label: 'Cluster 节点容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', equals: 'cluster' } },
      { key: 'master.persistence.enabled', label: 'Master 存储', control: 'switch', defaultValue: false, showWhen: { key: 'architecture', notEquals: 'cluster' } },
      { key: 'master.persistence.size', label: 'Master 容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', notEquals: 'cluster' } },
      { key: 'replica.persistence.enabled', label: 'Replica 存储', control: 'switch', defaultValue: false, showWhen: { key: 'architecture', equals: ['replication', 'sentinel'] } },
      { key: 'replica.persistence.size', label: 'Replica 容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', equals: ['replication', 'sentinel'] } },
    ],
  },
  mysql: {
    kind: 'database',
    ...
    fields: [
      ...
      { key: 'primary.persistence.enabled', label: 'Primary 存储', control: 'switch', defaultValue: false, showWhen: { key: 'architecture', notEquals: ['dual-master', 'galera'] } },
      { key: 'primary.persistence.size', label: 'Primary 容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', notEquals: ['dual-master', 'galera'] } },
      ...
      { key: 'secondary.persistence.size', label: 'Secondary 容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', equals: 'replication' } },
  ...
  postgresql: {
    ...
    fields: [
      ...
      { key: 'primary.persistence.enabled', label: 'Primary 存储', control: 'switch', defaultValue: false, showWhen: { key: 'architecture', notEquals: 'ha-cluster' } },
      { key: 'primary.persistence.size', label: 'Primary 容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', notEquals: 'ha-cluster' } },
      ...
      { key: 'readReplicas.persistence.size', label: 'Read Replica 容量', control: 'text', defaultValue: '8Gi', placeholder: '8Gi', showWhen: { key: 'architecture', equals: 'replication' } },
