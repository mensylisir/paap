...
.access-bar a { font-size: 13px; font-weight: 500; color: #1d4ed8; text-decoration: none; }
.access-bar a:hover { text-decoration: underline; }
.card-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 12px; }
.dash-card { background: #f9fafb; border: 1px solid #f1f3f5; border-radius: 8px; padding: 14px 16px; }
.link-card { display: block; text-decoration: none; color: inherit; transition: box-shadow .15s, border-color .15s; }
.link-card:hover { border-color: #d1d5db; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
.dash-name { font-weight: 600; font-size: 14px; color: #11181c; margin-bottom: 4px; }
.dash-meta { font-size: 12px; color: #687076; margin-bottom: 8px; }

.ok-box { padding: 14px 16px; background: #f0fdf4; color: #166534; font-size: 13px; border-radius: 8px; }
